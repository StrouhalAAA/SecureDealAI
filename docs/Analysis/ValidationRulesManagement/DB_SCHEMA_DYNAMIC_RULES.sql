...
-- Version: 1.1.0
-- Created: 2026-01-01
-- Updated: 2026-01-02 - Added BuyingType support for rule filtering
-- Purpose: Database schema for dynamic validation rules management
-- Target: Supabase PostgreSQL
-- ============================================================================
--
-- APPLICABILITY FILTERS:
--   VendorType: PHYSICAL_PERSON (FO), COMPANY (PO)
--   BuyingType: BRANCH (MVP default), MOBILE_BUYING (Phase 2)
--
-- Rules are filtered by these types in metadata.applicableTo and
-- metadata.applicableToBuyingType arrays.
-- ============================================================================
...
-- These support filtering rules by applicableTo and applicableToBuyingType arrays
...
-- This enables efficient rule loading for specific validation contexts
...
/*
-- Example: Insert VEH-001 rule with VendorType and BuyingType
...
-- Example: Query rules for BRANCH buying with COMPANY vendor
-- SELECT * FROM get_active_validation_rules_filtered('COMPANY', 'BRANCH');
*/
